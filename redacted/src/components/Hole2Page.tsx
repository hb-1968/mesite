...
// six gothic dialogue boxes deliver a redacted monologue, one
...
type DialogueContent = {
  ...
  // for the centered name moment). huge stretches the line(s) to fill
...
// 6 boxes. text contents redacted to ████ runs; pauses, styles, and
// structure preserved so the typewriter / click-pause beats still
// land the way the storyboard intended.
  ...
  },
  {
    ...
    content: {
      ...
      lines: [[
        { type: 'text', text: '███ ███ ████ ██ ███ ██████ ██ ██████ ███████████: █ ██' },
        { type: 'pause', ms: 2000 },
        { type: 'text', text: ' ████████ ████████', style: 'gothic-red' },
        { type: 'text', text: ', ███ ' },
        { type: 'text', text: '█ ██ ███ ███████████ ███.', style: 'red' }
      ]]
    }
